...
vcfR <- read.vcfR("C:/Users/lbreit/Documents/lara-zostera/project/local_data/populations.snps.vcf")
...
lines <- readLines("../local_data/popmap_test2.txt")
...
If we remove a lot of variance b/c they are low frequency (regarding MAF), it may be a lot of variation in low frequencies.
